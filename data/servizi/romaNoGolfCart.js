...
export const romaNoGolfCart = [
    ...
    new ServizioAdOre("Disposizione su Tivoli (non si calcola il transfer, solo dispo) (mezzi e ore)", "roma-no-golf-cart", {
      "1-2": 48,
      "3-5": 58,
      "6-7": 63,
      "8-10": 55,
    ...
    new ServizioPax("Basilica San Pietro (pax)", "roma-no-golf-cart", {
      "adulti": 6,
      "minori": 4,
    }),
